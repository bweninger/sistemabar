...
public interface PedidosApi {
    ...
    ResponseEntity<PedidoResponse> atualizarPedido(@ApiParam(value = "id do pedido", required = true) @PathVariable("idPedido") String idPedido, @ApiParam(value = "", required = true) @Valid @RequestBody AtualizarPedidoRequest atualizarPedidoRequest);
    ...
    ResponseEntity<PedidoResponse> buscarPedido(@ApiParam(value = "id do Pedido", required = true) @PathVariable("idPedido") String idPedido);
    ...
    ResponseEntity<Void> deletarPedido(@ApiParam(value = "id do Pedido", required = true) @PathVariable("idPedido") String idPedido);
    ...
    @RequestMapping(value = "/pedidos",
        produces = { "application/json;charset=utf-8" }, 
        method = RequestMethod.GET)
    ResponseEntity<PedidosResponseList> listarPedidos(@ApiParam(value = "Identificador da Comanda") @Valid @RequestParam(value = "idComanda", required = false) String idComanda, @ApiParam(value = "Data de Vigencia da Comanda") @Valid @RequestParam(value = "dataVigencia", required = false) LocalDate dataVigencia);
